...
//			System.out.println("user info: " + userInfo);
		...
		if (userInfo.get("uid") != null) {
			...
			if (userInfo.get("age_range") == null) {
				pw.println("<script>var kakaoAge = confirm('생년월일 (연령대) 정보가 없습니다.\\n\\n카카오 계정 관리 페이지로 이동하시겠습니까?'); if (kakaoAge) location.href = 'https://accounts.kakao.com/weblogin/account/profile'; else location.href = '" + request.getContextPath() + "/';</script>");
				return;
			}
