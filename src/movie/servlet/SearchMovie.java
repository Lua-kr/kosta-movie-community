...
public class SearchMovie extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query = URLEncoder.encode(request.getParameter("name"), "UTF-8");

		BufferedReader br;
		try {
			String urlstr = "https://api.themoviedb.org/3/search/movie?api_key=1409aaea037c127f018d970de4a17783&page=1&language=ko-kr&include_adult=false&query="
					+ query;
