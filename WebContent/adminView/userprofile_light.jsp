			...
			<nav class="navbar navbar-default navbar-custom">
				...
				<div class="navbar-header logo">
					...
					<a href="index_light.html"><img class="logo"
						src="images/logo1.png" alt="" width="119" height="58"></a>
				</div>
							...
							<ul class="dropdown-menu level1">
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									...
									<ul class="dropdown-menu level2">
										...
										<li><a href="moviegridfw_light.html">movie grid full
												width</a></li>
									</ul></li>
								<li><a href="movielist_light.html">Movie list</a></li>
								<li><a href="moviesingle_light.html">Movie single</a></li>
								<li class="it-last"><a href="seriessingle_light.html">Series
										single</a></li>
							</ul></li>
						<li class="dropdown first"><a
							class="btn btn-default dropdown-toggle lv1"
							...
							<ul class="dropdown-menu level1">
								<li><a href="celebritygrid01_light.html">celebrity grid
										01</a></li>
								<li><a href="celebritygrid02_light.html">celebrity grid
										02 </a></li>
								<li><a href="celebritylist_light.html">celebrity list</a></li>
								<li class="it-last"><a href="celebritysingle_light.html">celebrity
										single</a></li>
							</ul></li>
						<li class="dropdown first"><a
							class="btn btn-default dropdown-toggle lv1"
							...
							<ul class="dropdown-menu level1">
								...
								<li class="it-last"><a href="blogdetail_light.html">blog
										Detail</a></li>
							</ul></li>
						<li class="dropdown first"><a
							class="btn btn-default dropdown-toggle lv1"
							...
							<ul class="dropdown-menu level1">
								<li><a href="userfavoritegrid_light.html">user favorite
										grid</a></li>
								<li><a href="userfavoritelist_light.html">user favorite
										list</a></li>
								<li><a href="userprofile_light.html">user profile</a></li>
								<li class="it-last"><a href="userrate_light.html">user
										rate</a></li>
							</ul></li>
					</ul>
				...
				<div class="row ipad-width">
					<div class="col-md-3 col-sm-12 col-xs-12">
						<div class="sidebar" data-color="purple"
							...
							<a href="#" class="simple-text logo-mini"><h3>관리자 모드</h3></a><br>
							<div class="sidebar-wrapper">
								<div class="sidebar-inner-list">
									<ul class="nav" id="nav">
										...
										<li class="nav-item active" id="li">
											<p id="notice">공지관리</p> </a>
										</li>
										<li class="nav-item active" id="li">
											<p id="point">포인트상점관리</p> </a>
										</li>
						...
						<div class="form-style-1 user-pro" action="#">
							<div class="content">
								<div class="container-fluid">
									<!-- your content here -->
									<iframe src="admin/center.jsp" name="center" width="100%"
