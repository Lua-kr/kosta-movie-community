		...
		<!-- <div class="flex-wrap-movielist grid-fav"> -->
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				...
				<div class="mv-item-infor">
					<h6>
						<a href="${pageContext.request.contextPath}/moviesingle.html">oblivion</a>
					</h6>
					<p class="rate">
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img src="${pageContext.request.contextPath}/images/uploads/mv2.jpg"
					alt="">
				<div class="hvr-inner">
				...
				<div class="mv-item-infor">
					<h6>
						<a href="${pageContext.request.contextPath}/moviesingle.html">into
							the wild</a>
					</h6>
					<p class="rate">
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				...
				<div class="mv-item-infor">
					<h6>
						<a href="${pageContext.request.contextPath}/moviesingle.html">Die
							hard</a>
					</h6>
					<p class="rate">
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-item4.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img src="${pageContext.request.contextPath}/images/uploads/mv3.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img src="${pageContext.request.contextPath}/images/uploads/mv4.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img src="${pageContext.request.contextPath}/images/uploads/mv5.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-item1.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-item2.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-it10.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-it11.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-it12.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-item7.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-item8.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-it9.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-item9.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-item10.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="moviesingle.html"> Read more <i
						class="ion-android-arrow-dropright"></i>
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				...
				<div class="mv-item-infor">
					<h6>
						<a href="${pageContext.request.contextPath}/moviesingle.html">strager
							things</a>
					</h6>
					<p class="rate">
						<i class="ion-android-star"></i><span>7.4</span> /10
			...
			<div class="movie-item-style-2 movie-item-style-1 style-3">
				<img
					src="${pageContext.request.contextPath}/images/uploads/mv-item12.jpg"
					alt="">
				<div class="hvr-inner">
					<a href="${pageContext.request.contextPath}moviesingle.html">
						Read more <i class="ion-android-arrow-dropright"></i>
				...
				<div class="mv-item-infor">
					<h6>
						<a href="${pageContext.request.contextPath}/moviesingle.html">la
							la land</a>
					</h6>
					<p class="rate">
						<i class="ion-android-star"></i><span>7.4</span> /10
