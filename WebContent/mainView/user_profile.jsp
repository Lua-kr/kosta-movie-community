					...
					<form action="#" class="user">
						...
						<div class="row">
							<div class="col-md-6 form-it">
								<label>Email</label>
								<input type="text" value="email@address.com" disabled>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 form-it">
						...
						<div class="row" align="center">
							<div class="form-it">
								<fieldset>
									...
									<label class="checkbox-inline"><input type="checkbox" value="">Option 4</label><br>
									...
									<label class="checkbox-inline"><input type="checkbox" value="">Option 7</label>
									<label class="checkbox-inline"><input type="checkbox" value="">Option 8</label><br>
									&nbsp;&nbsp;<label class="checkbox-inline"><input type="checkbox" value="">Option 9</label>
									<label class="checkbox-inline"><input type="checkbox" value="">Option 10</label>
									<label class="checkbox-inline"><input type="checkbox" value="">Option 11</label>
									<label class="checkbox-inline"><input type="checkbox" value="">Option 12</label>
								</fieldset>
							</div>
						</div>
						<div class="row">
