...
--추가
INSERT INTO USER_ROLE values(URID_SEQ.NEXTVAL,'일반 회원',30,URID_SEQ.CURRVAL);
INSERT INTO USER_ROLE values(URID_SEQ.NEXTVAL,'정회원',30,URID_SEQ.CURRVAL);
...
-- 관리자 삽입
INSERT INTO USER_ADMIN VALUES(AID_SEQ.NEXTVAL, 1521001283); -- 박세진
...
--추가
INSERT INTO UPLOAD_FILE VALUES(FID_SEQ.NEXTVAL,1523124395,1,1,1,SYSDATE,0,0);
...
--추가 
INSERT INTO POINT_SHOP VALUES(PID_SEQ.NEXTVAL,1,1,1,1,0,1,1);

--게시글 업로드 테이블
CREATE TABLE FORUM_UPLOAD(
    U_ID INT PRIMARY KEY, --고유번호
    THREAD_ID INT REFERENCES FORUM_THREAD(U_ID) ON DELETE CASCADE, --글번호
    FILE_ID INT REFERENCES UPLOAD_FILE(U_ID) ON DELETE CASCADE--파일번호
);
DROP SEQUENCE  FU_ID_SEQ;
CREATE SEQUENCE FU_ID_SEQ NOCACHE;

--추가
INSERT INTO FORUM_UPLOAD VALUES(FU_ID_SEQ.NEXTVAL,3,1);
...
--글 카테고리 삽입
INSERT INTO FORUM_CATEGORY VALUES(0, 0, 0, 1); -- 자유 게시판
INSERT INTO FORUM_CATEGORY VALUES(1, 0, 0, 1); -- 공지 게시판
INSERT INTO FORUM_CATEGORY VALUES(2, 0, 0, 1); -- 리뷰 게시판
...
--추가
INSERT INTO FORUM_THREAD VALUES(FTID_SEQ.NEXTVAL,0,0,0,1523124395,0,0,0,0,0,SYSDATE);
...
--추가
INSERT INTO FORUM_NOTICE VALUES(FNID_SEQ.NEXTVAL,3,0);
...
--추가 
INSERT INTO FORUM_POST VALUES(FPID_SEQ.NEXTVAL,1,3,1523124395,1,SYSDATE);
...
--추가 
INSERT INTO FORUM_REVIEW VALUES(FRID_SEQ.NEXTVAL,4,1,1);
...
--추가 
INSERT INTO FORUM_VOTE VALUES(FVID_SEQ.NEXTVAL,1523124395,1,1,1,SYSDATE);
...
--추가 
INSERT INTO NOTIFICATION VALUES(NID_SEQ.NEXTVAL,1524671471,1523124395,1,1,SYSDATE,1);
...
--추가 
INSERT INTO USER_LETTER VALUES(NID_SEQ.NEXTVAL,1523124395,1524671471,1,SYSDATE,1);
...
--추가 
INSERT INTO MOVIE_USER_FAVORITE VALUES(MUFID_SEQ.NEXTVAL,1523124395,1,SYSDATE,1);
