...
CREATE TABLE USERLIST(
    ...
    ROLE_ID NUMBER(10) REFERENCES USER_ROLE(U_ID) ON DELETE CASCADE, --등급고유번호
    ...
    POINTS INT DEFAULT 0 ,--POINT
    VIEW_ADULT NUMBER(1) DEFAULT 0, --성인열람
...
CREATE TABLE POINT_SHOP(
    ...
    FILE_ID NUMBER(10) REFERENCES UPLOADFILE(U_ID) ON DELETE CASCADE, --파일번호
...
--영화 테이블
CREATE TABLE MOVIE(
    U_ID INT PRIMARY KEY, --영화 고유 아이디
    ...
    VOTE NUMBER(4),--평점
    VOTE_COUNT INT NOT NULL, --평점된 횟수
    BUDGET INT,--제작 예산
...
CREATE TABLE MOVIE_USER_FAVORITE(
    ...
    MOVIE_ID NUMBER(10) REFERENCES MOVIE(U_ID) ON DELETE CASCADE,--영화 고유 아이디
